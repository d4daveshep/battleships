...
1. When adding new FastAPI endpoints
2. When refactoring existing routes
3. When implementing new API features
4. When extracting business logic to services
5. When ensuring proper architectural layering
