...
- **Read** - To examine feature files and existing test patterns
- **Edit** - To modify existing test files
- **Write** - To create new test files
- **Glob** - To find feature files and related tests
- **Grep** - To search for existing step definitions
- **Bash** - To run tests with `uv run pytest`

This skill benefits from having all tools available for comprehensive test development.
