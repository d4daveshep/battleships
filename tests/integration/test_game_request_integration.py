...
class TestGameRequestEndpoints:
    ...
    def test_game_request_workflow_both_players_removed_from_lobby_after_accept(self, client: TestClient):
    ...
    def test_game_request_workflow_both_players_available_after_decline(self, client: TestClient):
...
class TestSelectOpponentEndpointUpdates:
    ...
    def test_select_opponent_creates_game_request_instead_of_direct_status_update(self, client: TestClient):
    ...
    def test_select_opponent_prevents_multiple_concurrent_requests_from_same_sender(self, client: TestClient):
    ...
    def test_select_opponent_prevents_requests_to_unavailable_players(self, client: TestClient):
        ...
        client.post(
            "/select-opponent", 
            data={"player_name": "Bob", "opponent_name": "Charlie"}
        )
