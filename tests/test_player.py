...
class TestPlayer:
    ...
    def test_place_ship(self):
        ...
        result = player.place_ship(ShipType.DESTROYER, Coordinate(0, 0), Direction.HORIZONTAL)
    ...
    def test_place_ship_invalid(self):
        ...
        result = player.place_ship(ShipType.CRUISER, Coordinate(0, 0), Direction.VERTICAL)
    ...
    def test_get_available_shots(self):
        ...
        # Place some ships
        player.place_ship(ShipType.CARRIER, Coordinate(0, 0), Direction.HORIZONTAL)  # 2 shots
        player.place_ship(ShipType.DESTROYER, Coordinate(2, 0), Direction.HORIZONTAL)  # 1 shot
        ...
        destroyer.hit(Coordinate(2, 0))
        destroyer.hit(Coordinate(2, 1))
    ...
    def test_is_defeated(self):
        ...
        destroyer.hit(Coordinate(0, 0))
        destroyer.hit(Coordinate(0, 1))
