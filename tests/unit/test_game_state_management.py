...
class GameStateManager:
    ...
    def start_multiplayer_game(self, player1: str, player2: str) -> tuple[GameState, GameState]:
...
class TestGameState:
    ...
    def test_single_player_game_state_with_opponent_fails(self):
        ...
        with pytest.raises(ValueError, match="Single player games cannot have an opponent"):
            GameState(
                player_name="Alice",
                game_mode=GameMode.SINGLE_PLAYER,
                opponent_name="Bob"
