...
class LobbyUpdateEvent:
    ...
    def __init__(self, event_type: str, player_name: str, timestamp: Optional[datetime] = None):
        self.event_type = event_type  # "join", "leave", "status_change", "request_sent", etc.
...
class LobbyEventTracker:
    ...
    def record_status_change(self, player_name: str, old_status: PlayerStatus, new_status: PlayerStatus):
...
class TestLobbyEventTracker:
    ...
    def test_record_status_change(self):
        ...
        tracker.record_status_change("Alice", PlayerStatus.AVAILABLE, PlayerStatus.REQUESTING_GAME)
