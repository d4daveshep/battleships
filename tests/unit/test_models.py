...
#         positions: list[Coordinate] = ship.place_ship(start, Direction.HORIZONTAL)
#         expected: list[Coordinate] = [Coordinate(0, 0), Coordinate(0, 1)]
...
#         ship: Ship = Ship(ShipType.DESTROYER)  # Length 2
#         start: Coordinate = Coordinate(0, 0)
#         positions: list[Coordinate] = ship.place_ship(start, Direction.VERTICAL)
#
#         expected: list[Coordinate] = [Coordinate(0, 0), Coordinate(1, 0)]
#         assert positions == expected
#         assert ship.positions == expected
#
...
#         positions: list[Coordinate] = ship.place_ship(start, Direction.DIAGONAL_NE)
#
#         expected: list[Coordinate] = [Coordinate(1, 0), Coordinate(0, 1)]
#         assert positions == expected
#         assert ship.positions == expected
#
...
#         ship: Ship = Ship(ShipType.DESTROYER)  # Length 2
#         start: Coordinate = Coordinate(0, 0)
#         positions: list[Coordinate] = ship.place_ship(start, Direction.DIAGONAL_SE)
#
#         expected: list[Coordinate] = [Coordinate(0, 0), Coordinate(1, 1)]
#         assert positions == expected
#         assert ship.positions == expected
#
